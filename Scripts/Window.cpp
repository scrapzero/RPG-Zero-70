...
void CEquipmentWindow::Draw()
{
	...
	DrawFormatString(16, 485, BLACK, "SKILL1 %sÅFè¡îÔMP %d   à–óÕ %dÅ@ëÆê´ %s  P”∞ƒﬁ %s", skillName[0].c_str(), skillMP[0], skillPower[0], skillElement[0].c_str(),skillRatioKind[0].c_str());
	DrawFormatString(16, 505, BLACK,"ì¡éÍå¯â :%s",skillExperience[0].c_str());
	if (equipmentKind <= 2) {
		DrawFormatString(16, 525, BLACK, "SKILL2 %sÅFè¡îÔMP %d   à–óÕ %dÅ@ëÆê´ %s  P”∞ƒﬁ %s", skillName[1].c_str(), skillMP[1], skillPower[1], skillElement[1].c_str(),skillRatioKind[1].c_str());
